...
export default function RegisterButton() {
  ...
  return (
    <>
      {pending ? (
        <button className="w-full border border-black mt-9 text-black bg-slate-100 hover:text-slate-400 focus:outline-none font-medium text-sm px-5 py-2.5 text-center">
          LOADING ...
        </button>
      ) : (
        <button
